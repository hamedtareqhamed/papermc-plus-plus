...
def generate_headers():
    ...
    FALLBACK_ENTRIES = {
        "minecraft:damage_type": [
            ...
            "minecraft:sonic_boom", "minecraft:spear", "minecraft:spit", "minecraft:stalagmite",
            "minecraft:starve", "minecraft:sting", "minecraft:sulfur_cube_hot", "minecraft:sweet_berry_bush",
        ...
        "minecraft:timeline": ["minecraft:day", "minecraft:moon", "minecraft:early_game", "minecraft:villager_schedule"],
